...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        lineEdit->setGeometry(QRect(50, 370, 541, 24));
        label = new QLabel(centralwidget);
        label->setObjectName("label");
        label->setGeometry(QRect(50, 350, 541, 16));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label->setText(QCoreApplication::translate("MainWindow", "Messaggio insermento", nullptr));
    } // retranslateUi
